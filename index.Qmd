...
**Per calcolare il numero di osservazioni necessarie per trarre una conclusione con ragionevole sicurezza dobbiamo ipotizzare una certa dimensione dell'effetto.** Noi abbiamo ipotizzato uno sbilanciamento verso "testa" oppure "croce" del *"60% vs 40%"*. Se fosse stato *"90% vs 10%"* il gioco sarebbe stato ben più facile... ma meno divertente, e poi in Psicologia sappiamo che non è mai così "facile"! Il calcolo di quante osservazioni siano necessarie può essere fatto spesso con delle formule. In casi più complessi si può **simulare il fenomeno**: un po' per esemplificare, un po' perché ci diverte, ora abbiamo simulato, anche se avremmo potuto usare le formule. Guardate la seguente figura e poi leggete la spiegazione sotto.
...
La figura mostra la "speranza" di vincere al gioco della moneta affidandosi alla maggioranza dei risultati dei lanci. **Nel gioco, come nella realtà, e anche in ricerca, alla fine dobbiamo prendere decisioni**. Nel gioco della moneta come si decideva? A un certo punto si guardava se fossero uscite una maggioranza di "testa" o di "croce", e ci si affidava a quello.

La figura sopra mostra quale sia la "speranza" di indovinare la verità dopo un certo numero di lanci. Stando alla nostra ipotesi, dopo un solo lancio la "speranza" di indovinare sarebbe del 60% (se esce "testa" dico "testa", altrimenti "croce"). Ma **dopo 25 lanci questa "speranza" a quanto è salita? A circa l'85%. Come vedete, non è ancora una certezza!**
...
Cos'è cambiato in questa figura? Rispetto a prima, abbiamo aggiunto anche i numeri di lanci "pari". Con quale risultato? Che coi lanci "pari" si può osservare un "pareggio" tra "teste" e "croci", lasciandoci così complemente incerti e senza elementi per sbilanciarci. È un problema? Sì e no. Senza entrare in discussioni troppo complesse, e con grossolana approssimazione, questo voleva esemplificare il fatto che, **a volte, in ricerca ci troviamo in condizioni di tale incertezza da non poter proprio decidere niente, ma anche questa incertezza può essere, per così dire, prevista fin dall'inizio... Tenete conto che in tutto questo *racconto* nessuna moneta è stata effettivamente lanciata, ma abbiamo comunque imparato parecchie cose :-)**
